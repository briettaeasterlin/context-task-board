...
import { Copy, Check, Key, ChevronDown, Trash2, ToggleLeft, ToggleRight, AlertCircle, CheckCircle, AlertTriangle } from 'lucide-react';
        ...
        <Card className="p-4 rounded-xl shadow-card space-y-3">
          ...
          {parsedPayload && (
            <Card className="p-3 bg-muted/30 rounded-lg space-y-2">
              <p className="text-sm font-medium">Preview — {parsedPayload.operation_id}</p>
          ...
          {createdKey ? (
            ...
            <div className="space-y-3">
              <div>
                <Label>Label</Label>
                <Input
                  placeholder="e.g. ChatGPT Vector, Claude Scheduled"
                  value={newKeyLabel}
