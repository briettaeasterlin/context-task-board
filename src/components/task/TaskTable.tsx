...
export function TaskTable({ tasks, selectedIds, onToggleSelect, onSelectAll, onTaskClick, onInlineUpdate }: Props) {
  return (
      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b bg-muted/50">
            ...
            <th className="text-left p-2 font-medium text-muted-foreground text-xs w-[100px]">Area</th>
            <th className="text-left p-2 font-medium text-muted-foreground text-xs w-[100px]">Status</th>
