...
const CATEGORY_CONFIG: Record<WorkCategory, CategoryConfig> = {
  pipeline: {
    ...
    borderClass: 'border-l-line-central',
    bgClass: 'bg-line-central/[0.04]',
    headerClass: 'text-line-central',
    dotClass: 'bg-line-central',
  },
  client: {
    label: 'Piccadilly · Client Work',
    icon: <Briefcase className="h-4 w-4" />,
    borderClass: 'border-l-line-piccadilly',
    bgClass: 'bg-line-piccadilly/[0.04]',
    headerClass: 'text-line-piccadilly',
    dotClass: 'bg-line-piccadilly',
  },
  business: {
    label: 'Metropolitan · Business',
    icon: <Settings className="h-4 w-4" />,
    borderClass: 'border-l-line-metropolitan',
    bgClass: 'bg-line-metropolitan/[0.04]',
    headerClass: 'text-line-metropolitan',
    dotClass: 'bg-line-metropolitan',
  },
  personal: {
    label: 'Elizabeth · Personal',
    icon: <Heart className="h-4 w-4" />,
    borderClass: 'border-l-line-elizabeth',
    bgClass: 'bg-line-elizabeth/[0.04]',
    headerClass: 'text-line-elizabeth',
    dotClass: 'bg-line-elizabeth',
  },
};
